...
{
    public class FromBodyOrOtherSourcesAttributeConvention : IParameterModelConvention, IActionModelConvention, IControllerModelConvention, IApplicationModelConvention
    {
        ...
        public FromBodyOrOtherSourcesAttributeConvention(bool enableForParametersWithNoBinding, bool enableForParametersWithFormRouteQueryBinding,  bool changeFromBodyBindingsToFromBodyOrFormRouteQueryBinding)
        {
