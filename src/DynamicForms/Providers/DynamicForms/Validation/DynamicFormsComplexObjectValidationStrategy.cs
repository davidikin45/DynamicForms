...
{
    public class DynamicFormsComplexObjectValidationStrategy : IValidationStrategy
    {
        private static readonly bool IsMono = Type.GetType("Mono.Runtime") != null;
        public static readonly IValidationStrategy Instance = new DynamicFormsComplexObjectValidationStrategy();

        private DynamicFormsComplexObjectValidationStrategy()
        {
        ...
        {
            if (metadata is DynamicFormsModelMetadata)
            {
                return GetChildren(((DynamicFormsModelMetadata)metadata), key, model);
            }
            else
            {
        ...
        public IEnumerator<ValidationEntry> GetChildren(
            DynamicFormsModelMetadata metadata,
            string key,
            object model)
        {
